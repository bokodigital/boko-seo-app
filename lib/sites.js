...
/** This app's half of the site key. The WordPress studio uses "wordpress". */
export const APP_KIND = "shopify";
...
/** The store a connected session points at. */
export function siteOf(session) {
  return (session && session.shop) || "";
}
